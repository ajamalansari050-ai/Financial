...
// Global Language Switcher Script for Fengoo.in (Fixed for Calculators)
...
function applyLanguage(lang) {
    ...
    // Translate only regular elements, EXCLUDING input boxes and calculator fields
    let elements = document.querySelectorAll(`[data-${lang}]`);
    elements.forEach(el => {
        // अगर यह इनपुट बॉक्स नहीं है, तभी इसका टेक्स्ट बदलें ताकि नंबर डिलीट न हों
